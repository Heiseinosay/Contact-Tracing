...
Public Class Form6MallLoc
    ...
    Private Sub btnTimeIn_Click(sender As Object, e As EventArgs) Handles btnTimeIn.Click
        ...
        If completed = True Then
            ...
            Else
                DTTable = ExecuteQuery("INSERT INTO TimeEnter VALUES(" & scannedID & ", GETDATE(), CURRENT_TIMESTAMP, 101);")
            End If
        End If
        txtScanID.Text = ""
        completed = False
    ...
    Private Sub btnTimeOut_Click(sender As Object, e As EventArgs) Handles btnTimeOut.Click
        ...
        If completed = True Then
            ...
            DTTable = ExecuteQuery("SELECT * FROM Persons WHERE ID = " & scannedID)
            MaxRows = DTTable.Rows.Count
            DTTable = ExecuteQuery("SELECT * FROM TimeEnter WHERE PersonID = " & scannedID & "AND locationID = 101")
            ...
            Else
                DTTable = ExecuteQuery("INSERT INTO TimeExit VALUES(" & scannedID & ", GETDATE(), CURRENT_TIMESTAMP, 101);")
            End If
        End If
        txtScanID.Text = ""
        completed = False
    ...
    Private Sub Form6MallLoc_Load(sender As Object, e As EventArgs) Handles MyBase.Load
